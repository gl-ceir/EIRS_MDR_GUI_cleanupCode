...
//console.log("intialController ---" +intialController);		
$(document)
		.ready(
				function() {
					...
					$('ul#sidebarUlID').find('li a[href="' + intialController + '"]').closest('li').addClass("active");											
...
$('.navbar-nav li').on('click', function() {
	//alert("inside on click");
	$('.navbar-nav li:not(.inactive)').addClass("inactive");
