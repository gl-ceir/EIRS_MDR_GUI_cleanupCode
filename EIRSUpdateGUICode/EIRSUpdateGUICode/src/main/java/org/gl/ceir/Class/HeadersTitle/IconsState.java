...
public class IconsState {
	...
	public String adminGrievanceState(String fileName,String txnId ,String grievanceId,String status,String userStatus,int userId) {
		...
		// state related Code 
		String reply = "<div class='d-flex'><a onclick="+replyAction+" class=\"waves-effect waves-light modal-trigger\"><i class="+replyIcon+" aria-hidden=\"true\" title="
				+replyIconTitle+" ></i></a>";
		String view="<a onclick="+viewAction+" class=\"waves-effect waves-light modal-trigger\"><i class="+viewIcon+" aria-hidden=\"true\" title="
				+viewIconTitle+" ></i></a></div>";

		log.info("status is--->" +status+"---userStatus---->"+userStatus);

		if(("0".equals(status) || "1".equals(status) || "2".equals(status)) && "Approved".equals(userStatus)) {
			 reply = "<div class='d-flex'><a onclick="+replyAction+" class=\"waves-effect waves-light modal-trigger\"><i class="+replyIcon+" aria-hidden=\"true\" title="
					+replyIconTitle+" ></i></a>";
			 view="<a onclick="+viewAction+" class=\"waves-effect waves-light modal-trigger\"><i class="+viewIcon+" aria-hidden=\"true\" title="
					+viewIconTitle+" ></i></a></div>";
			...
			reply = "<div class='d-flex'><a onclick="+replyAction+" class=\"eventNone\"><i class="+disableReplyIcon+" aria-hidden=\"true\" title="
					+replyIconTitle+" ></i></a></div>";
		}
	...
	public String iconsDeviceManagement (String tac,String requestType,Integer deviceState,Integer rowId) {
		executePostConstruct();
		// URL link 
		//log.info("status---->"+status+"---------AdminCurrentStatus------>"+AdminCurrentStatus+" userStatus----------->" +userStatus);
		String action = null;
