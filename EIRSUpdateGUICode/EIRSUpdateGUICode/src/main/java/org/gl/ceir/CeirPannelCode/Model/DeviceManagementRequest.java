...
public class DeviceManagementRequest {
	...
	private Integer customPriceOfDevice;
	...
	private Integer launchPriceAsianMarket;
	private Integer launchPriceCambodiaMarket;
	private Integer launchPriceEuropeMarket;
	private Integer launchPriceInternationalMarket;
	private Integer launchPriceUSMarket;
	...
	public Integer getCustomPriceOfDevice() {
		return customPriceOfDevice;
	}
	public void setCustomPriceOfDevice(Integer customPriceOfDevice) {
	...
	public Integer getLaunchPriceAsianMarket() {
		return launchPriceAsianMarket;
	}
	public void setLaunchPriceAsianMarket(Integer launchPriceAsianMarket) {
		this.launchPriceAsianMarket = launchPriceAsianMarket;
	}
	public Integer getLaunchPriceCambodiaMarket() {
		return launchPriceCambodiaMarket;
	}
	public void setLaunchPriceCambodiaMarket(Integer launchPriceCambodiaMarket) {
		this.launchPriceCambodiaMarket = launchPriceCambodiaMarket;
	}
	public Integer getLaunchPriceEuropeMarket() {
		return launchPriceEuropeMarket;
	}
	public void setLaunchPriceEuropeMarket(Integer launchPriceEuropeMarket) {
		this.launchPriceEuropeMarket = launchPriceEuropeMarket;
	}
	public Integer getLaunchPriceInternationalMarket() {
		return launchPriceInternationalMarket;
	}
	public void setLaunchPriceInternationalMarket(Integer launchPriceInternationalMarket) {
		this.launchPriceInternationalMarket = launchPriceInternationalMarket;
	}
	public Integer getLaunchPriceUSMarket() {
		return launchPriceUSMarket;
	}
	public void setLaunchPriceUSMarket(Integer launchPriceUSMarket) {
	...
	public String toString() {
		...
		builder.append("DeviceManagementRequest [allocationDate=");
		...
		builder.append(networkTechnologyLTEInterp);
		builder.append(", nonremovableEUICC=");
		builder.append(nonremovableEUICC);
		builder.append(", nonremovableUICC=");
		builder.append(nonremovableUICC);
		builder.append(", oem=");
		builder.append(oem);
