...
public class DeviceFilterRequest {
	...
	public Double getSourceOfCambodiaMarketPrice() {
		return sourceOfCambodiaMarketPrice;
	}
	public void setSourceOfCambodiaMarketPrice(Double sourceOfCambodiaMarketPrice) {
	...
	public String toString() {
		...
		builder.append("DeviceFilterRequest [soundLoudspeaker=");
