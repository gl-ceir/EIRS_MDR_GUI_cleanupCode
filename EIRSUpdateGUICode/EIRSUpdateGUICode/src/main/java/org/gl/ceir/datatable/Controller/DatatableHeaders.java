...
//Rule feature Mapping
			...
			//Schedule Headers
				...
				String[] headers = {"table.device.creationDate","table.device.modificationDate","input.TAC","table.devicetype","table.ProductName","imei.MarketingName","registration.modelname","select.stockStatus","<label class='checkbox-container'>"+Translator.toLocale("table.selectAll")+"<input type='checkbox' id='selectAllCheckbox' onchange='selectAllCheckbox()'><span class='checkmark'></span></label>"};
			...
			//Device Management
				...
				String[] headers = {"table.device.creationDate","table.device.modificationDate","input.TAC","table.devicetype","table.ProductName","imei.MarketingName","registration.modelname","select.stockStatus","table.action"};
				log.info("headers when requestType is " +requestType);
				for(String header : headers) {
					dataTableInputs.add(new DatatableHeaderModel(Translator.toLocale(header)));
				}
				...
				String[] headers = {"table.device.creationDate","table.device.modificationDate","input.TAC","table.devicetype","table.ProductName","imei.MarketingName","registration.modelname","select.stockStatus","Agent Name","table.action"};
				for(String header : headers) {
					dataTableInputs.add(new DatatableHeaderModel(Translator.toLocale(header)));
				}
				return new ResponseEntity<>(dataTableInputs, HttpStatus.OK);
